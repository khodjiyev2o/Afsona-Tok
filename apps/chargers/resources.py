...
class FinishedChargingTransactionProxyResource(resources.ModelResource):
    class Meta:
        ...
        export_order = ('id', "connector__charge_point__name", 'created_at', 'meter_used', 'total_price')
        fields = ('id', 'connector__charge_point__name', 'created_at', 'meter_used', 'total_price')
        name = _("Export Charging Transactions")

    def get_export_headers(self, fields=None):
        return [_("ID"), _("Charger Name"), _("Created At"), _("Meter Used"), _("Total Price")]
